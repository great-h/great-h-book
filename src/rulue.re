...
リポジトリのひとつひとつにIssuesがあり、すごい広島のウェブサイトのリポジトリん中のIssuesに宣言します。
...
すごい広島には@<tt>great-h.github.io</tt>というリポジトリがあります。
...
宣言するやることには特に制限はなく、その日に終わらなくても構いません。
...
注意点があり、はじめての場合はラベルやマイルストーンは設定できません。
リポジトリへのアクセス権限が必要なためです。
...
自由に過ごしていただいてかまいませんが、自分が考えたこと、学んだことを忘れても大丈夫なようにウェブ上に記録を残してください。
これは簡単なように、意外と難しいです。
時間内でできることを考え、まとめられる範囲を意識しつつ無理のないようにやることが大切です。
負担が少ない方法としてはTwitterに書き込みしてTogetterなどのサービスを使いツイートをまとめたり、やること宣言のIssueにコメントしてかきこむなどの方法があります。
...
すごい広島のウェブサイトを更新するには、@<href>{https://github.com/great-h/great-h.github.io}のファイルを変更する必要があります。
直接変更することもできますが、GitHubのPull Requestという機能を使って行ってください。
...
しかし、独りで学習するのはいつでも自分で選択して時間を確保することができます。
すごい広島の時間は誰かに教えてもらったり、質問したりすることができる時間と考えることをおすすめします。
プログラミングは初めてのことに挑戦すると、ときどき簡単なことに時間を取られてしまうことがあります。
