...
すごい広島は各回に専用のページがありますので、そこに一日のふりかえりを載せます。
...
ふりかえりをウェブサイトを記述しますが、ふりかえりにはYWTを利用しています。

YWTはやったこと(Y)、わかったこと(W),次にやりたいこと(T)の3つでふりかえりを行います。

Yでは、やったことを書きだすことで、作業全体を俯瞰できるようにしまu.

Wでは、やったことのなかから学んだことを書きだします。
やったことを先に書きだしているので、わかったことがスムーズに書きだすことができます。

Tでは未来をみます。過去を振り替えると未来にやりたいことがみえてきます。
わかったことから、次にやりたいことを書きだしてみましょう。
